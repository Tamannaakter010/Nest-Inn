...
import heroImagee from "./heroImagee.png"; // Ensure this file exists
...
export const experiences = [
  {
    ...
    description: "Experience the thrill of dune bashing and a magical desert sunset.",
    image: assets.heroImagee, // Now correctly references the imported heroImagee
    price: 150,
  },
  {
    _id: 2,
    title: "Cultural City Tour",
    description: "Explore historic landmarks and vibrant markets with a local guide.",
    image: assets.heroImagee,
    price: 80,
  },
  {
    _id: 3,
    title: "Mountain Hiking Expedition",
    description: "Trek through stunning trails with breathtaking views.",
    image: assets.heroImagee,
    price: 200,
  },
];
