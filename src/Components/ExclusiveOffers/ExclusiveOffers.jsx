...
import { Link } from "react-router-dom"; // CHANGE: Imported Link for navigation
  ...
  return (
    <div className="relative container mx-auto p-2 md:p-4">
      <div className="flex text-center justify-between mb-6">
        ...
        {/* CHANGE: Wrapped button in Link to navigate to /offers */}
        <Link to="/offers">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        {exclusiveOffers.map((item) => (
          // CHANGE: Wrapped offer card in Link to navigate to /offers
          <Link to="/offers" key={item._id}>
            <div
            ...
            >
              <div className="absolute inset-0 bg-black/40 flex flex-col justify-between p-4">
                ...
                <div className="text-white">
                  ...
                  {/* CHANGE: Ensured View Offer button is within Link */}
